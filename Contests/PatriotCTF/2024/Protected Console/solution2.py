...
with remote("0.0.0.0", 1337) as nc:
	...
	def padding_oracle_request(iv, ciphertext):
	...
	iv, enc_admin = forge_CBC_ciphertext_with_batched_padding_oracle(admin, padding_oracle_request, padding_oracle_read, hint = (guest[ : 16], iv, enc_guest[ : 16]), faulty = True)[0]
