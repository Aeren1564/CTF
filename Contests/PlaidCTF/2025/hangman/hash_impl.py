...
indexshiftbox = data[0x3260:0x3360]
kshiftbox = data[0x3360:0x3460]
...
def main():
	...
	# abalone + b'\x00' + own salt
	result = hash_compute(bandit_salt, bytes.fromhex('6162616c6f6e6500f2a8bed6a2eb8d3e07bfa9e55edbffaa'))
	print(result.hex())
	# LD_LIBRARY_PATH=. ./hash 588fe10356c0412c74a5db5f8f1f1930 6162616c6f6e6500f2a8bed6a2eb8d3e07bfa9e55edbffaa
